window.CPP_INTERVIEW_QUESTIONS = [
  ...
  },
  {
    ...
    "group": "ue5",
    "category": "ue5/xr-vr",
    "title": "UE5 VR 项目为什么通常优先接 OpenXR（开放式 XR 标准）？",
    "difficulty": 2,
    "scopes": [
      "UE5"
    ],
    "answer": "OpenXR 把头显、手柄输入和常见运行时封装成统一接口，UE5 可以用同一套动作映射适配多家设备。平台专有功能仍要查厂商插件或扩展，常规移动、输入和渲染流程不应该一上来就绑死在某个 SDK 上。",
    "source": "资料依据：Epic Games · OpenXR Prerequisites and OpenXR Input"
  },
  {
    "id": "382",
    "group": "ue5",
    "category": "ue5/xr-vr",
    "title": "VRPawn、Camera 和 Motion Controller（运动控制器）通常怎么组织？",
    "difficulty": 2,
    "scopes": [
      "UE5"
    ],
    "answer": "VRPawn 负责承载玩家在场景中的 XR 原点，Camera 跟随 HMD（头戴显示器）追踪，左右 Motion Controller 组件跟随手柄或手部输入。PlayerStart 的朝向会影响玩家初始朝向，抓取、射线和手部网格应挂在控制器下面，避免把普通 Character 的摄像机逻辑直接套进 VR。",
    "source": "资料依据：Epic Games · VR Template Pawn and Motion Controller Components"
  },
  {
    "id": "383",
    "group": "ue5",
    "category": "ue5/xr-vr",
    "title": "Teleport（传送）和 Snap Turn（离散转向）为什么适合做 VR 默认移动？",
    "difficulty": 2,
    "scopes": [
      "UE5"
    ],
    "answer": "Teleport 用瞬移替代持续推着相机移动，可以减少视觉运动和前庭感受不一致带来的眩晕。Snap Turn 一次转过固定角度，比平滑旋转更容易被多数玩家接受，落点还要受导航网格和碰撞限制。",
    "source": "资料依据：Epic Games · VR Template Locomotion and XR Comfort"
  },
  {
    "id": "384",
    "group": "ue5",
    "category": "ue5/xr-vr",
    "title": "VR 中为什么不要随便改 FOV（视场角）？",
    "difficulty": 3,
    "scopes": [
      "UE5"
    ],
    "answer": "VR 的投影和视场角由头显设备和运行时决定，强行改 FOV 会让画面比例、深度和头部转动反馈不匹配。更可靠的做法是保持真实设备投影，通过世界尺度、相机高度、移动方式和交互节奏来处理舒适度。",
    "source": "资料依据：Epic Games · XR Best Practices Field of View"
  },
  {
    "id": "385",
    "group": "ue5",
    "category": "ue5/xr-vr",
    "title": "World To Meters（世界到米比例）设置错了会出现什么问题？",
    "difficulty": 3,
    "scopes": [
      "UE5"
    ],
    "answer": "World To Meters 决定 Unreal 单位和玩家真实身高、距离感之间的换算，数值错误会让角色像巨人或小人，也会影响抓取距离和空间判断。VR 项目通常保持 1 Unreal Unit 等于 1 厘米，只在明确需要改变体感尺度时成套调整。",
    "source": "资料依据：Epic Games · XR Best Practices World Scale"
  },
  {
    "id": "386",
    "group": "ue5",
    "category": "ue5/xr-vr",
    "title": "OpenXR 的 Grip Pose（握持姿态）和 Aim Pose（瞄准姿态）有什么区别？",
    "difficulty": 2,
    "scopes": [
      "UE5"
    ],
    "answer": "Grip Pose 表示手柄被握持时适合放置物体或手模型的位置，Aim Pose 表示用于射线指向和菜单瞄准的方向。抓取物体通常跟随 Grip，远距离 UI 或传送指示通常跟随 Aim，混用会让手感和视觉方向对不上。",
    "source": "资料依据：Epic Games · OpenXR Input Grip Pose and Aim Pose"
  },
  {
    "id": "387",
    "group": "ue5",
    "category": "ue5/xr-vr",
    "title": "VR 抓取物体时为什么要把输入、碰撞检测和手部显示分开？",
    "difficulty": 3,
    "scopes": [
      "UE5"
    ],
    "answer": "输入只表达玩家按下抓取动作，碰撞或射线负责确定候选物体，手部网格只是反馈当前姿态和抓取状态。这样同一套交互可以适配不同手柄、手部追踪和网络同步，也能避免用显示模型的位置直接决定玩法结果。",
    "source": "资料依据：Epic Games · VR Template Input and Interaction"
  },
  {
    "id": "388",
    "group": "ue5",
    "category": "ue5/xr-vr",
    "title": "VR 里怎样用手柄射线点击 3D UMG（虚幻动态图形界面）？",
    "difficulty": 3,
    "scopes": [
      "UE5"
    ],
    "answer": "常见做法是在世界中放 Widget Component，再把 Widget Interaction Component 挂到手柄或手部射线上。扳机按下时调用对应的 Press Pointer Key，松开时调用 Release Pointer Key，悬停、点击和调试射线都由这个交互组件处理。",
    "source": "资料依据：Epic Games · Widget Interaction Component"
  },
  {
    "id": "389",
    "group": "ue5",
    "category": "ue5/xr-vr",
    "title": "Quest 或移动 VR 和 PC VR 的性能策略有什么不同？",
    "difficulty": 3,
    "scopes": [
      "UE5"
    ],
    "answer": "移动 VR 的 CPU、GPU、带宽和散热余量都比 PC VR 小，不能把桌面级后处理、动态阴影和高面数场景直接搬过去。UE5 项目需要按目标设备选择移动多视图、LOD、贴图预算、固定注视点渲染等能力，并用真机帧率验证。",
    "source": "资料依据：Epic Games · Developing for Oculus VR and VR Performance Features"
  },
  {
    "id": "390",
    "group": "ue5",
    "category": "ue5/xr-vr",
    "title": "VR 性能优化为什么优先看稳定帧率和延迟？",
    "difficulty": 3,
    "scopes": [
      "UE5"
    ],
    "answer": "VR 中掉帧和高延迟会直接影响舒适度，因为用户头部运动需要尽快反映到画面里。优化时先用 Unreal Insights、stat 和平台工具区分 CPU 或 GPU 瓶颈，再决定用实例化立体渲染、剔除、LOD 或材质降级。",
    "source": "资料依据：Epic Games · VR Performance and Profiling"
  },
  {
    "id": "391",
    "group": "ue5",
    "category": "ue5/xr-vr",
    "title": "OpenXR 和厂商插件之间怎么取舍，比如 Meta Quest 手部追踪？",
    "difficulty": 3,
    "scopes": [
      "UE5"
    ],
    "answer": "OpenXR 适合作为跨设备基础层，输入和常规 XR 流程尽量走标准接口。手部追踪、固定注视点渲染等厂商特性可能依赖对应插件或扩展，项目要按目标平台确认支持矩阵，避免在 PC VR 和 Quest 上假设功能完全一致。",
    "source": "资料依据：Epic Games · OpenXR and Oculus VR Platform Features"
  },
  {
    "id": "392",
    "group": "ue5",
    "category": "ue5/xr-vr",
    "title": "VR Spectator Screen（旁观者屏幕）适合解决什么问题？",
    "difficulty": 2,
    "scopes": [
      "UE5"
    ],
    "answer": "Spectator Screen 用来给不戴头显的人看监视器画面，常用于演示、录制和调试体验流程。它可能需要额外渲染目标或场景捕获，移动 VR 支持也有限，所以正式项目要把它当作展示功能而不是核心玩法链路。",
    "source": "资料依据：Epic Games · Virtual Reality Spectator Screen"
  },
  {
    "id": "393",
    "group": "ue5",
    "category": "ue5/xr-vr",
    "title": "Hand Tracking（手部追踪）和手柄输入同时支持时接口怎么抽象？",
    "difficulty": 3,
    "scopes": [
      "UE5"
    ],
    "answer": "玩法层不应该直接依赖某一种设备，而是把抓取、指向、确认和取消抽象成动作，再把手柄、手势或手部骨骼映射到这些动作。手部追踪还要暴露追踪置信度、左右手状态和降级路径，追踪丢失时能自然回退到手柄或空手状态。",
    "source": "资料依据：Epic Games · OpenXR Input and Hand Tracking；Meta Developers · Meta Quest Hand Tracking in Unreal"
  },
  {
    "id": "394",
    "group": "ue5",
    "category": "ue5/xr-vr",
    "title": "手部追踪做抓取或手势识别时为什么不能只看单帧骨骼？",
    "difficulty": 3,
    "scopes": [
      "UE5"
    ],
    "answer": "手部骨骼数据会受遮挡、光照和预测影响，单帧判断很容易在临界姿态附近抖动。更稳的做法是用连续帧、阈值滞回、置信度和手势优先级确认状态，交互结果只在稳定后触发。",
    "source": "资料依据：Epic Games · OpenXR Hand Tracking；Meta Developers · Hand Tracking Quality and Gesture Input"
  },
  {
    "id": "395",
    "group": "ue5",
    "category": "ue5/xr-vr",
    "title": "大空间 Room-scale VR 为什么要区分 Tracking Origin（追踪原点）？",
    "difficulty": 3,
    "scopes": [
      "UE5"
    ],
    "answer": "Tracking Origin 决定 HMD 和控制器坐标是相对设备启动点、地面还是舞台空间解释。大空间体验通常更关心地面高度、玩家真实位移和可行走边界，所以要明确使用 Floor 或 Stage 语义，并把虚拟角色根节点和追踪空间对齐。",
    "source": "资料依据：Epic Games · XR Tracking Origin and Room Scale"
  },
  {
    "id": "396",
    "group": "ue5",
    "category": "ue5/xr-vr",
    "title": "大空间 VR 中玩家真实走动和虚拟移动怎么叠加？",
    "difficulty": 4,
    "scopes": [
      "UE5"
    ],
    "answer": "真实走动来自追踪系统更新 HMD 在 XR 空间中的相对位置，虚拟移动通常作用在 VROrigin 或 Pawn 根节点上。两者叠加时要保持胶囊碰撞、地面高度和安全边界一致，重定位或回正时也要同步手柄、身体和交互射线。",
    "source": "资料依据：Epic Games · VR Template Pawn, Locomotion and Tracking Space"
  },
  {
    "id": "397",
    "group": "ue5",
    "category": "ue5/xr-vr",
    "title": "XR 透视 Passthrough 和普通相机背景有什么区别？",
    "difficulty": 3,
    "scopes": [
      "UE5"
    ],
    "answer": "Passthrough 是由 XR 运行时把设备摄像头画面和虚拟内容合成到头显里，开发者通常拿到的是可配置的透视层或相关 API。普通游戏相机背景只是引擎渲染内容，不能自动代表真实世界，也不等于可以自由读取原始摄像头图像。",
    "source": "资料依据：Epic Games · OpenXR Passthrough；Meta Developers · Meta XR Passthrough"
  },
  {
    "id": "398",
    "group": "ue5",
    "category": "ue5/xr-vr",
    "title": "XR 透视交互里如何处理虚实遮挡和安全边界？",
    "difficulty": 4,
    "scopes": [
      "UE5"
    ],
    "answer": "透视画面本身只提供真实世界背景，遮挡关系还需要深度、场景理解、锚点或手动放置的代理几何来参与判断。安全边界不能只靠视觉效果提示，移动、抓取和生成物体都要考虑玩家可活动区域和平台权限。",
    "source": "资料依据：Epic Games · OpenXR Passthrough and XR Scene Understanding；Meta Developers · Passthrough and Scene API"
  },
  {
    "id": "399",
    "group": "ue5",
    "category": "ue5/xr-vr",
    "title": "VR 全身 IK（FBIK）通常用哪些输入目标？",
    "difficulty": 3,
    "scopes": [
      "UE5"
    ],
    "answer": "VR 全身 IK 通常把 HMD 作为头部目标，把左右控制器或手部追踪作为手目标，再根据项目需要加入骨盆、脚和膝盖约束。FBIK 负责在骨骼链上分配误差和保持姿态，目标点不是直接等同于最终骨骼变换。",
    "source": "资料依据：Epic Games · Full-Body IK in Control Rig"
  },
  {
    "id": "400",
    "group": "ue5",
    "category": "ue5/xr-vr",
    "title": "VR 全身 IK 为什么必须做身高、臂展和骨骼比例校准？",
    "difficulty": 3,
    "scopes": [
      "UE5"
    ],
    "answer": "不同玩家的真实身高、肩宽和臂长差异很大，直接把同一套骨架套到所有人身上会导致手够不到、肩膀塌陷或脚底漂浮。校准阶段用 HMD、手柄和可选站姿数据估计比例，再让 IK 在合理约束内求解，动画表现会稳定很多。",
    "source": "资料依据：Epic Games · IK Rig, Retargeting and Full-Body IK"
  },
  {
    "id": "401",
    "group": "ue5",
    "category": "ue5/xr-vr",
    "title": "VR 移动处理为什么通常移动 VROrigin 或 XR Origin，而不是直接改 Camera？",
    "difficulty": 3,
    "scopes": [
      "UE5"
    ],
    "answer": "Camera 的相对位姿由 HMD 追踪实时驱动，直接改 Camera 会和设备追踪结果互相覆盖。虚拟移动应作用在 VROrigin、XR Origin 或 Pawn 根节点上，让头显、手柄、碰撞体和交互射线保持同一个空间基准。",
    "source": "资料依据：Epic Games · VR Template Pawn and XR Origin Movement"
  },
  {
    "id": "402",
    "group": "ue5",
    "category": "ue5/xr-vr",
    "title": "连续移动、传送和碰撞修正怎么避免眩晕和穿墙？",
    "difficulty": 4,
    "scopes": [
      "UE5"
    ],
    "answer": "连续移动要控制加速度、转向方式和速度上限，传送要验证 NavMesh、落点空间和玩家朝向。碰撞修正应移动玩家根节点或胶囊并保留 HMD 相对偏移，不能把相机强行推回墙外造成突兀画面跳变。",
    "source": "资料依据：Epic Games · VR Template Locomotion and Player Collision"
  },
  {
    "id": "301",
    "group": "windows",
